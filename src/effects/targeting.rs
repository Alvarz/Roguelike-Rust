use crate::game::components::{Equipped, InBackpack, Position};
use crate::map::Map;
use specs::prelude::*;
...
pub fn aoe_tiles(map: &Map, target: bracket_lib::prelude::Point, radius: i32) -> Vec<i32> {
    let mut blast_tiles = bracket_lib::prelude::field_of_view(target, radius, &*map);
